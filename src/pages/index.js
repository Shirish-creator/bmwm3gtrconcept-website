...
export default function Home() {
  return (
    ...
    <div class="container mx-auto px-12 flex flex-row items-center justify-between ">
  <div className="flex flex-row gap-8 items-center w-fit">
    <img src="/bmwlogo.png"></img>
  ...
  <button style={{padding:"4px 48px"}} className=" rounded-3xl h-fit  border-2 border-slate-100 hidden lg:block">Book Test Drive</button>
    <div className="block lg:hidden"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
